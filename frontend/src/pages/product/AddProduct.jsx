...
const AddProduct = () => {
  ...
  const [variants, setVariants] = useState([{ characteristicName: "", characteristicValue: "" }]);
  ...
  const handleAddProduct = () => {
    ...
    if (
      ...
      const isVariantsValid = variantsToSend.every(
        (variant) =>
          variant.characteristicName.trim() !== "" && variant.characteristicValue.trim() !== ""
      );
      if (!isVariantsValid) {
  ...
  return (
    <div className="container mt-3 p-4 rounded" style={{ background: "#d2b48c" }}>
      <h2 className="text-center mb-4" style={{ color: "#704214" }}>Добавление товара</h2>
